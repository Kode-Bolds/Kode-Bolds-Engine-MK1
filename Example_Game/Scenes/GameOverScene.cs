...
namespace OpenGL_Game.Scenes
{
    class GameOverScene : Scene, IScene
    {
        ...
        {
            //Set window title
            sceneManager.Title = "DOOMED - Game Over";
        ...
        public void Render(FrameEventArgs e)
        {
            ...
            GUI.DrawText(new Rectangle(0, (int)(fontSize / 2f), (int)width, (int)(fontSize * 2f)), "DOOMED", (int)(fontSize * 1.5f), StringAlignment.Center, Color.Black);
            GUI.DrawText(new Rectangle(0, (int)(fontSize / 2f + 200), (int)width, (int)(fontSize * 2f)), "GAME OVER!", (int)fontSize, StringAlignment.Center, Color.Black);
            GUI.DrawText(new Rectangle(0, (int)(fontSize / 2f + 400), (int)width, (int)(fontSize * 2f)), "Press R To Retry", (int)(fontSize / 1.5f), StringAlignment.Center, Color.Black);
            GUI.DrawText(new Rectangle(0, (int)(fontSize / 2f + 600), (int)width, (int)(fontSize * 2f)), "Press M For Menu", (int)(fontSize / 1.5f), StringAlignment.Center, Color.Black);

            GUI.Render(Color.Red);
        }
